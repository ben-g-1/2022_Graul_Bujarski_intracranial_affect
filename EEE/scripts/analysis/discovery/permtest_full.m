...
base.adj_prob = reshape(base.prob(2,:), [], 1);
[base.h, base.crit_p, base.adj_ci_cvrg, base.adj_p]=fdr_bh(base.adj_prob,.05,'dep','yes');
...
adj_prob = reshape(norm.prob(2,:), [], 1);
[norm.h, norm.crit_p, norm.adj_ci_cvrg, norm.adj_p]=fdr_bh(adj_prob,.05,'dep','yes');
...
for k = a:b % channels in this chunk
    for ii = 1:perms % permute each factor separately 
