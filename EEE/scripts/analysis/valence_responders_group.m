...
datadir = strcat('C:\Users\bgrau\Dropbox (Dartmouth College)\2023_Graul_EEE\Data\processed\sub-', sub, '\imgview');
filename = 'imgview_freq_bpref.mat';

cd(datadir);
load('imgview_bpref.mat')
...
save("imgview_freq_bpref_4kres.mat", "imgview_freq", "-v7.3")

% clear imgview_freq data
end
