...
% Requires cfg.dataset, cfg.trialdef.event, cfg.trialdef.eventvalue, 
% cfg.trialdef.pre, cfg.trialdef.post, cfg.trialdef.offset
...
% find all trials where phase is provided value for viewing image
