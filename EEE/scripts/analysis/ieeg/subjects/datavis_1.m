...
high_cue_ratings = stim_table.val_rating(stim_table.highcue_indx == 1); % Replace 'high_cue_ratings' with the column name in your dataset
low_cue_ratings = stim_table.val_rating(stim_table.highcue_indx == -1); % Replace 'low_cue_ratings' with the column name in your dataset
...
[~, p, ~, stats] = ttest2(high_cue_ratings, low_cue_ratings);
