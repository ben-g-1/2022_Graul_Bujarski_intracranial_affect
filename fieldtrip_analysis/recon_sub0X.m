...
subjID           = 'sub0X'; % for generating subject-specific filenames
mrfile           = 'XXX_MRI.nii'; % single file of a DICOM series or a nifti file
ctfile           = 'XXX_CT.nii'; % single file of a DICOM series or a nifti file
eegfile          = 'XXX.EDF'; % recording file (e.g., edf)
...
mrifile          = 'subdir/R21AMY05_MRI.nii'
tmpfile          = 'subdir/tmp.nii';
